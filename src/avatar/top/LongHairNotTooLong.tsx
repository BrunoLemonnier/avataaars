...
setAvailableTypeFor &&
  setAvailableTypeFor('LongHairNotTooLong', ['hairColor', 'facialHairType'])

export interface LongHairNotTooLongProps {
...
export const LongHairNotTooLong: React.FC<LongHairNotTooLongProps> = ({
  hairColor,
  facialHairType,
  facialHairColor,
  accessoriesType,
...
interface LongHairNotTooLongComponentProps {
  hairColor?: keyof typeof HairColors
  FacialHair: React.ReactElement
  Accessory: React.ReactElement
}
export const LongHairNotTooLongComponent: React.FC<LongHairNotTooLongComponentProps> = ({
  FacialHair,
  hairColor,
  Accessory,
}) => {
  ...
  return (
    <g
      ...
      strokeWidth='1'
      fillRule='evenodd'
      data-testid='Top/LongHairNotTooLong'>
      <defs>
