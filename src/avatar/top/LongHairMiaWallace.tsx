...
setAvailableTypeFor &&
  setAvailableTypeFor('LongHairMiaWallace', ['hairColor', 'facialHairType'])
...
export const LongHairMiaWallace: React.FC<LongHairMiaWallaceProps> = ({
  hairColor,
  facialHairType,
  facialHairColor,
  accessoriesType,
...
interface LongHairMiaWallaceComponentProps {
  hairColor?: keyof typeof HairColors
  FacialHair: React.ReactElement
  Accessory: React.ReactElement
}
export const LongHairMiaWallaceComponent: React.FC<LongHairMiaWallaceComponentProps> = ({
  FacialHair,
  hairColor,
  Accessory,
}) => {
