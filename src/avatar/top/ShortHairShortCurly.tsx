...
setAvailableTypeFor &&
  setAvailableTypeFor('ShortHairShortCurly', ['hairColor', 'facialHairType'])

export interface ShortHairShortCurlyProps {
...
export const ShortHairShortCurly: React.FC<ShortHairShortCurlyProps> = ({
  hairColor,
  facialHairType,
  facialHairColor,
  accessoriesType,
...
interface ShortHairShortCurlyComponentProps {
  hairColor?: keyof typeof HairColors
  FacialHair: React.ReactElement
  Accessory: React.ReactElement
}
export const ShortHairShortCurlyComponent: React.FC<ShortHairShortCurlyComponentProps> = ({
  FacialHair,
  hairColor,
  Accessory,
}) => {
  ...
  return (
    <g
      ...
      strokeWidth='1'
      fillRule='evenodd'
      data-testid='Top/ShortHairShortCurly'>
      <defs>
