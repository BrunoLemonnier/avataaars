...
setAvailableTypeFor &&
  setAvailableTypeFor('LongHairStraight', ['hairColor', 'facialHairType'])

export interface LongHairStraightProps {
...
export const LongHairStraight: React.FC<LongHairStraightProps> = ({
  hairColor,
  facialHairType,
  facialHairColor,
  accessoriesType,
...
interface LongHairStraightComponentProps {
  hairColor?: keyof typeof HairColors
  FacialHair: React.ReactElement
  Accessory: React.ReactElement
}
export const LongHairStraightComponent: React.FC<LongHairStraightComponentProps> = ({
  FacialHair,
  hairColor,
  Accessory,
}) => {
  ...
  return (
    <g
      ...
      strokeWidth='1'
      fillRule='evenodd'
      data-testid='Top/LongHairStraight'>
      <defs>
