...
setAvailableTypeFor &&
  setAvailableTypeFor('ShortHairTheCaesar', ['hairColor', 'facialHairType'])

export interface ShortHairTheCaesarProps {
...
export const ShortHairTheCaesar: React.FC<ShortHairTheCaesarProps> = ({
  hairColor,
  facialHairType,
  facialHairColor,
  accessoriesType,
...
interface ShortHairTheCaesarComponentProps {
  hairColor?: keyof typeof HairColors
  FacialHair: React.ReactElement
  Accessory: React.ReactElement
}
export const ShortHairTheCaesarComponent: React.FC<ShortHairTheCaesarComponentProps> = ({
  FacialHair,
  hairColor,
  Accessory,
}) => {
  ...
  return (
    <g
      ...
      strokeWidth='1'
      fillRule='evenodd'
      data-testid='Top/ShortHairTheCaesar'>
      <defs>
