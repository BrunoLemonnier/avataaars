...
setAvailableTypeFor &&
  setAvailableTypeFor('Turban', ['hatColor', 'facialHairType'])

export interface TurbanProps {
...
export const Turban: React.FC<TurbanProps> = ({
  hatColor,
  facialHairType,
  facialHairColor,
  accessoriesType,
...
interface TurbanComponentProps {
  hatColor?: keyof typeof HatColors
  FacialHair: React.ReactElement
  Accessory: React.ReactElement
}

export const TurbanComponent: React.FC<TurbanComponentProps> = ({
  hatColor,
  FacialHair,
  Accessory,
}) => {
  ...
  const HatColor: React.FC<{
    maskID: string
  }> = hatColor ? HatColors[hatColor] : HatColors.Blue03

  return (
    <g id='Top' strokeWidth='1' fillRule='evenodd' data-testid='Top/Turban'>
      <defs>
