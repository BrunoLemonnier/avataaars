...
setAvailableTypeFor &&
  setAvailableTypeFor('Hat', ['hatColor', 'facialHairType'])
...
interface HatComponentProps {
  FacialHair: React.ReactElement
  Accessory: React.ReactElement
}

export const HatComponent: React.FC<HatComponentProps> = ({
  FacialHair,
  Accessory,
}) => {
  ...
  return (
    <g id='Top/Hat' strokeWidth='1' fillRule='evenodd' data-testid='Top/Hat'>
      <defs>
