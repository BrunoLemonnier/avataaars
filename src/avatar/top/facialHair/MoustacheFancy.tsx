...
setAvailableTypeFor &&
  setAvailableTypeFor('MoustacheFancy', ['facialHairColor'])

export interface MoustacheFancyProps {
  facialHairColor?: keyof typeof Colors
}

export const MoustacheFancy: React.FC<MoustacheFancyProps> = ({
  facialHairColor,
}) => {
  ...
  return (
    <g
      id='FacialHair/Moustache-Fancy'
      transform='translate(49.000000, 72.000000)'
      data-testid='FacialHair/MoustacheFancy'>
      <defs>
        <path
