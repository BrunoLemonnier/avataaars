...
setAvailableTypeFor &&
  setAvailableTypeFor('WinterHat4', ['hatColor', 'facialHairType'])

export interface WinterHat4Props {
...
export const WinterHat4: React.FC<WinterHat4Props> = ({
  hatColor,
  facialHairType,
  facialHairColor,
  accessoriesType,
...
interface WinterHat4ComponentProps {
  FacialHair: React.ReactElement
  Accessory: React.ReactElement
  hatColor?: keyof typeof HatColors
}
export const WinterHat4Component: React.FC<WinterHat4ComponentProps> = ({
  hatColor,
  FacialHair,
  Accessory,
}) => {
  ...
  return (
    <g id='Top' data-testid='Top/WinterHat4'>
      <defs>
