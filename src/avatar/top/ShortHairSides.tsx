...
setAvailableTypeFor &&
  setAvailableTypeFor('ShortHairSides', ['hairColor', 'facialHairType'])

export interface ShortHairSidesProps {
...
export const ShortHairSides: React.FC<ShortHairSidesProps> = ({
  hairColor,
  facialHairType,
  facialHairColor,
  accessoriesType,
...
interface ShortHairSidesComponentProps {
  hairColor?: keyof typeof HairColors
  FacialHair: React.ReactElement
  Accessory: React.ReactElement
}
export const ShortHairSidesComponent: React.FC<ShortHairSidesComponentProps> = ({
  FacialHair,
  hairColor,
  Accessory,
}) => {
  ...
  return (
    <g
      ...
      strokeWidth='1'
      fillRule='evenodd'
      data-testid='Top/ShortHairSides'>
      <defs>
