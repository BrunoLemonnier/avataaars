...
setAvailableTypeFor &&
  setAvailableTypeFor &&
  setAvailableTypeFor('Eyepatch', ['facialHairType'])

export interface EyepatchProps {
...
export const Eyepatch: React.FC<EyepatchProps> = ({
  facialHairType,
  facialHairColor,
  accessoriesType,
}) => {
...
interface EyepatchComponentProps {
  FacialHair: React.ReactElement
  Accessory: React.ReactElement
}
export const EyepatchComponent: React.FC<EyepatchComponentProps> = ({
  FacialHair,
}) => {
