...
setAvailableTypeFor &&
  setAvailableTypeFor('ShortHairShortFlat', ['hairColor', 'facialHairType'])

export interface ShortHairShortFlatProps {
...
export const ShortHairShortFlat: React.FC<ShortHairShortFlatProps> = ({
  hairColor,
  facialHairType,
  facialHairColor,
  accessoriesType,
...
interface ShortHairShortFlatComponentProps {
  hairColor?: keyof typeof HairColors
  FacialHair: React.ReactElement
  Accessory: React.ReactElement
}
export const ShortHairShortFlatComponent: React.FC<ShortHairShortFlatComponentProps> = ({
  FacialHair,
  hairColor,
  Accessory,
}) => {
  ...
  return (
    <g
      ...
      strokeWidth='1'
      fillRule='evenodd'
      data-testid='Top/ShortHairShortFlat'>
      <defs>
