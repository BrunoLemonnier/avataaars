...
setAvailableTypeFor &&
  setAvailableTypeFor('LongHairCurly', ['hairColor', 'facialHairType'])

export interface LongHairCurlyProps {
...
export const LongHairCurly: React.FC<LongHairCurlyProps> = ({
  hairColor,
  facialHairType,
  facialHairColor,
  accessoriesType,
...
interface LongHairCurlyComponentProps {
  hairColor?: keyof typeof HairColors
  FacialHair: React.ReactElement
  Accessory: React.ReactElement
}
export const LongHairCurlyComponent: React.FC<LongHairCurlyComponentProps> = ({
  FacialHair,
  hairColor,
  Accessory,
}) => {
