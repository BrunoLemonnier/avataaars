...
import { Colors as HatColors } from './HatColor'
...
setAvailableTypeFor &&
  setAvailableTypeFor('WinterHat2', ['hatColor', 'facialHairType'])

export interface WinterHat2Props {
...
export const WinterHat2: React.FC<WinterHat2Props> = ({
  hatColor,
  facialHairType,
  facialHairColor,
  accessoriesType,
...
interface WinterHat2ComponentProps {
  FacialHair: React.ReactElement
  Accessory: React.ReactElement
  hatColor?: keyof typeof HatColors
}

export const WinterHat2Component: React.FC<WinterHat2ComponentProps> = ({
  hatColor,
  FacialHair,
  Accessory,
}) => {
  ...
  const HatColor: React.FC<{
    maskID: string
  }> = hatColor ? HatColors[hatColor] : HatColors.Blue01

  return (
    <g id='Top' data-testid='Top/WinterHat2'>
      <defs>
