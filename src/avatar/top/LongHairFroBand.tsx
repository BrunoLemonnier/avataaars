...
setAvailableTypeFor &&
  setAvailableTypeFor('LongHairFroBand', ['hairColor', 'facialHairType'])

export interface LongHairFroBandProps {
...
export const LongHairFroBand: React.FC<LongHairFroBandProps> = ({
  hairColor,
  facialHairType,
  facialHairColor,
  accessoriesType,
...
interface LongHairFroBandComponentProps {
  hairColor?: keyof typeof HairColors
  FacialHair: React.ReactElement
  Accessory: React.ReactElement
}
export const LongHairFroBandComponent: React.FC<LongHairFroBandComponentProps> = ({
  FacialHair,
  hairColor,
  Accessory,
}) => {
  ...
  return (
    <g
      ...
      strokeWidth='1'
      fillRule='evenodd'
      data-testid='Top/LongHairFroBand'>
      <defs>
