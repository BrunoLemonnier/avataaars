...
setAvailableTypeFor &&
  setAvailableTypeFor('WinterHat1', ['hatColor', 'facialHairType'])

export interface WinterHat1Props {
...
export const WinterHat1: React.FC<WinterHat1Props> = ({
  hatColor,
  facialHairType,
  facialHairColor,
  accessoriesType,
...
interface WinterHat1ComponentProps {
  FacialHair: React.ReactElement
  Accessory: React.ReactElement
  hatColor?: keyof typeof HatColors
}

export const WinterHat1Component: React.FC<WinterHat1ComponentProps> = ({
  hatColor,
  FacialHair,
  Accessory,
}) => {
  ...
  return (
    <g id='Top' data-testid='Top/WinterHat1'>
      <defs>
