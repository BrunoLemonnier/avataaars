...
setAvailableTypeFor &&
  setAvailableTypeFor('ShortHairShaggy', ['hairColor', 'facialHairType'])

export interface ShortHairShaggyProps {
...
export const ShortHairShaggy: React.FC<ShortHairShaggyProps> = ({
  hairColor,
  facialHairType,
  facialHairColor,
  accessoriesType,
...
interface ShortHairShaggyComponentProps {
  hairColor?: keyof typeof HairColors
  FacialHair: React.ReactElement
  Accessory: React.ReactElement
}
export const ShortHairShaggyComponent: React.FC<ShortHairShaggyComponentProps> = ({
  FacialHair,
  hairColor,
  Accessory,
}) => {
  ...
  return (
    <g
      ...
      strokeWidth='1'
      fillRule='evenodd'
      data-testid='Top/ShortHairShaggy'>
      <defs>
