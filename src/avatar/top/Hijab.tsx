...
setAvailableTypeFor &&
  setAvailableTypeFor &&
  setAvailableTypeFor('Hijab', ['hatColor'])

export interface HijabProps {
...
interface HijabComponentProps {
  hatColor?: keyof typeof HatColors
  Accessory: React.ReactElement
}

export const HijabComponent: React.FC<HijabComponentProps> = ({
  Accessory,
  hatColor,
}) => {
