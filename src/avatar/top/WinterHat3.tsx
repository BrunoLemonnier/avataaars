...
setAvailableTypeFor &&
  setAvailableTypeFor('WinterHat3', ['hatColor', 'facialHairType'])

export interface WinterHat3Props {
...
export const WinterHat3: React.FC<WinterHat3Props> = ({
  hatColor,
  facialHairType,
  facialHairColor,
  accessoriesType,
...
interface WinterHat3ComponentProps {
  FacialHair: React.ReactElement
  Accessory: React.ReactElement
  hatColor?: keyof typeof HatColors
}

export const WinterHat3Component: React.FC<WinterHat3ComponentProps> = ({
  hatColor,
  FacialHair,
  Accessory,
}) => {
  ...
  const HatColor: React.FC<{
    maskID: string
  }> = hatColor ? HatColors[hatColor] : HatColors.Red

  return (
    <g id='Top' data-testid='Top/WinterHat3'>
      <defs>
