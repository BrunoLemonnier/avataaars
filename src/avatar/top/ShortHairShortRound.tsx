...
setAvailableTypeFor &&
  setAvailableTypeFor('ShortHairShortRound', ['hairColor', 'facialHairType'])

export interface ShortHairShortRoundProps {
...
export const ShortHairShortRound: React.FC<ShortHairShortRoundProps> = ({
  hairColor,
  facialHairType,
  facialHairColor,
  accessoriesType,
...
interface ShortHairShortRoundComponentProps {
  hairColor?: keyof typeof HairColors
  FacialHair: React.ReactElement
  Accessory: React.ReactElement
}
export const ShortHairShortRoundComponent: React.FC<ShortHairShortRoundComponentProps> = ({
  FacialHair,
  hairColor,
  Accessory,
}) => {
  ...
  return (
    <g
      ...
      strokeWidth='1'
      fillRule='evenodd'
      data-testid='Top/ShortHairShortRound'>
      <defs>
