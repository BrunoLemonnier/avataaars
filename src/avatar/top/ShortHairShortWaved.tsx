...
export interface ShortHairShortWavedProps {
...
export const ShortHairShortWaved: React.FC<ShortHairShortWavedProps> = ({
  hairColor,
  facialHairType,
  facialHairColor,
  accessoriesType,
...
interface ShortHairShortWavedComponentProps {
  hairColor?: keyof typeof HairColors
  FacialHair: React.ReactElement
  Accessory: React.ReactElement
}
export const ShortHairShortWavedComponent: React.FC<ShortHairShortWavedComponentProps> = ({
  FacialHair,
  hairColor,
  Accessory,
}) => {
  ...
  return (
    <g
      ...
      strokeWidth='1'
      fillRule='evenodd'
      data-testid='Top/ShortHairShortWaved'>
      <defs>
