...
export class SadConcernedNatural extends React.Component<{ opacity?: number }> {
  ...
  render() {
    return (
      <g
        ...
        data-testid='Eyebrow/SadConcernedNatural'>
        <path
...
export const Component = SadConcernedNatural
