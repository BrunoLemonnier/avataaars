...
export const ShortHairShortFlat: React.FC<TopProps> = ({
  children,
  color,
  opacity,
}) => {
  ...
  return (
    <g
      ...
      strokeWidth='1'
      fillRule='evenodd'
      data-testid='Style/ShortHairShortFlat'>
      <defs>
      ...
      <g id='Mask' />
      <g id='Style/Short-Hair/Short-Flat' mask={`url(#${mask2})`}>
...
export const Component = ShortHairShortFlat
