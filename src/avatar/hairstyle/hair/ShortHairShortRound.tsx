...
export const ShortHairShortRound: React.FC<TopProps> = ({
  children,
  color,
  opacity,
}) => {
  ...
  return (
    <g
      ...
      strokeWidth='1'
      fillRule='evenodd'
      data-testid='Style/ShortHairShortRound'>
      <defs>
      ...
      <g id='Mask' />
      <g id='Style/Short-Hair/Short-Round' mask={`url(#${mask2})`}>
...
export const Component = ShortHairShortRound
