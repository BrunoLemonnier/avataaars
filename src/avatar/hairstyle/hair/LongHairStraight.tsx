...
export const LongHairStraight: React.FC<TopProps> = ({
  children,
  color,
  opacity,
}) => {
  ...
  return (
    <g
      ...
      strokeWidth='1'
      fillRule='evenodd'
      data-testid='Style/LongHairStraight'>
      <defs>
      ...
      <g id='Mask' />
      <g id='Style/Long-Hair/Straight' mask={`url(#${mask1})`}>
...
export const Component = LongHairStraight
