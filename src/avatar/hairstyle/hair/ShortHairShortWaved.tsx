...
export const ShortHairShortWaved: React.FC<TopProps> = ({
  children,
  color,
  opacity,
}) => {
  ...
  return (
    <g
      ...
      strokeWidth='1'
      fillRule='evenodd'
      data-testid='Style/ShortHairShortWaved'>
      <defs>
      ...
      <g id='Mask' />
      <g id='Style/Short-Hair/Short-Waved' mask={`url(#${mask2})`}>
...
export const Component = ShortHairShortWaved
