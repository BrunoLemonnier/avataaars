...
export const ShortHairShaggy: React.FC<TopProps> = ({
  children,
  color,
  opacity,
}) => {
  ...
  return (
    <g
      ...
      strokeWidth='1'
      fillRule='evenodd'
      data-testid='Style/ShortHairShaggy'>
      <defs>
      ...
      <g id='Mask' />
      <g id='Style/Short-Hair/Shaggy' mask={`url(#${mask2})`}>
...
export const Component = ShortHairShaggy
