...
export const LongHairNotTooLong: React.FC<TopProps> = ({
  children,
  color,
  opacity = 1,
}) => {
  ...
  return (
    <g
      ...
      strokeWidth='1'
      fillRule='evenodd'
      data-testid='Style/LongHairNotTooLong'>
      <defs>
      ...
      <g id='Mask' />
      <g id='Style/Long-Hair/Long-but-not-too-long' mask={`url(#${mask1})`}>
        <g transform='translate(-1.000000, 0.000000)'>
          <g id='Behind' strokeWidth='1' fillRule='evenodd' opacity={opacity}>
...
export const Component = LongHairNotTooLong
