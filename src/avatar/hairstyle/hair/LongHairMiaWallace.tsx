...
import { LONG_HAIR } from '../Category'
import { TopProps } from '../Top'

export const category = LONG_HAIR

export const associatedTypes = ['hairColor', 'facialHairType']

export const LongHairMiaWallace: React.FC<TopProps> = ({
  children,
  color,
  opacity,
}) => {
  ...
  return (
    <g
      ...
      strokeWidth='1'
      fillRule='evenodd'
      data-testid='Style/LongHairFroBand'>
      <defs>
      ...
      <g id='Mask' />
      <g id='Style/Long-Hair/Mia-Wallace' mask={`url(#${mask1})`}>
...
export const Component = LongHairMiaWallace
