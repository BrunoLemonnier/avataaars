...
export const WinterHat4: React.FC<TopProps> = ({
  color,
  opacity,
  children,
}) => {
  ...
  const HeadgearColor: React.FC<{
    maskID: string
  }> = isHeadGearColor(color) ? HeadgearColors[color] : HeadgearColors.Red

  return (
    <g id='Style' data-testid='Style/WinterHat4'>
      <defs>
      ...
      <g id='Mask' />
      <g
        id='Style/Accessory/Winter-Hat-4'
        ...
        <g id='hat-front' opacity={opacity}>
          <use
            fill='black'
            fillOpacity='1'
            filter={`url(#${path4})`}
...
export const Component = WinterHat4
