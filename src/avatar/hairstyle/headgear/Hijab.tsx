...
export const associatedTypes = ['headgearColor']

export const Hijab: React.FC<TopProps> = ({ children, color, opacity = 1 }) => {
  ...
  return (
    <g
      ...
      <g id='Mask' />
      <g id='Style/Accesories/Hijab' mask={`url(#${mask1})`}>
