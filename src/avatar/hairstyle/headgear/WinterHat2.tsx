...
export const WinterHat2: React.FC<TopProps> = ({
  color,
  opacity,
  children,
}) => {
  ...
  const HeadgearColor: React.FC<{
    maskID: string
  }> = isHeadGearColor(color) ? HeadgearColors[color] : HeadgearColors.Blue02

  return (
    <g id='Style' data-testid='Style/WinterHat2'>
      <defs>
      ...
      <g id='Mask' />
      <g
        id='Style/Accessory/Winter-Hat-2'
...
export const Component = WinterHat2
