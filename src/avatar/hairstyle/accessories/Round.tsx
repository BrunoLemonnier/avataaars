...
import { AccessoriesProps } from './Accessories'
import { uniqueId } from 'lodash'

export class Round extends React.Component<AccessoriesProps> {
  ...
  render() {
    ...
    return (
      <g
        id='Style/_Resources/Round'
        fill='none'
        transform='translate(62.000000, 85.000000)'
        data-testid='Accessories/Round'
