...
export class Prescription02 extends React.Component<AccessoriesProps> {
  ...
  render() {
    ...
    return (
      <g
        id='Style/_Resources/Prescription-02'
        fill='none'
        transform='translate(62.000000, 85.000000)'
        strokeWidth='1'
        opacity={this.props.opacity}
        data-testid='Accessories/Prescription02'>
        <defs>
          <filter
            x='-0.8%'
            y='-2.4%'
...
export const Component = Prescription02
