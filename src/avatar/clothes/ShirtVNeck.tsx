...
setAvailableTypeFor &&
  setAvailableTypeFor &&
  setAvailableTypeFor('ShirtVNeck', ['clotheColor'])

export interface ShirtVNeckProps {
  clotheColor?: keyof typeof Colors
}
export const ShirtVNeck: React.FC<ShirtVNeckProps> = ({ clotheColor }) => {
  ...
  return (
    <g
      ...
      data-testid='Clothing/ShirtVNeck'>
      <defs>
        <path
